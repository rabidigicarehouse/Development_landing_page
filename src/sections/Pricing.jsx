        ...
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          {pricingData.map((plan, index) => (
            ...
            >
              ...
              <div className="mb-12">
                <div className="mb-8 flex h-20 w-20 items-center justify-center rounded-3xl border border-black/5 bg-slate-50 shadow-sm transition-all duration-700 group-hover:-translate-y-1 group-hover:scale-105 group-hover:shadow-[0_0_34px_rgba(79,140,255,0.2)] dark:border-white/10 dark:bg-white/5">
                  {plan.icon}
                </div>
