    ...
    <section className="section section-theme-violet flex min-h-screen items-center overflow-hidden py-16 xl:py-20 2xl:py-20" id="cta">
      ...
      <div className="container laptop-scale-section relative z-10 mx-auto flex w-full justify-center px-6 text-center">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative overflow-hidden rounded-[2.5rem] xl:rounded-[2.7rem] 2xl:rounded-[3rem] border border-slate-200 bg-white p-10 shadow-2xl dark:border-white/5 dark:bg-[#0c0f1d] md:p-14 xl:p-14 2xl:p-16"
        >
          ...
          <div className="relative z-10">
            <motion.div
              ...
              viewport={{ once: true }}
              className="mb-6 xl:mb-7 2xl:mb-8 inline-flex items-center gap-2 rounded-full border border-black/10 bg-black/[0.05] px-5 xl:px-6 py-2.5 xl:py-3 dark:border-white/10 dark:bg-white/[0.05]"
            >
              <TerminalSquare className="h-4 w-4 text-primary" />
              <span className="text-sm font-medium uppercase tracking-wide text-slate-700 dark:text-gray-300">Ready to ship?</span>
            </motion.div>

            <h2 className="font-heading mb-5 xl:mb-6 text-4xl font-black tracking-tight text-slate-950 dark:text-white md:text-6xl xl:text-[3.8rem] 2xl:text-6xl">
              Let&apos;s build something
              <br />
              <span className="text-gradient">production-grade.</span>
            </h2>

            <p className="mx-auto mb-10 xl:mb-11 2xl:mb-12 max-w-2xl text-lg xl:text-[1.15rem] 2xl:text-xl font-light text-slate-600 dark:text-gray-400">
            ...
            <a href="#contact" onClick={(e) => handleScrollTo(e, '#contact')} className="inline-block w-full md:w-auto">
              <Button variant="primary" className="group w-full rounded-full px-8 xl:px-9 2xl:px-10 py-[1.125rem] xl:py-[1.15rem] 2xl:py-5 text-base xl:text-[1.05rem] 2xl:text-lg shadow-2xl shadow-primary/40 hover:scale-105 md:w-auto">
                Connect Us
