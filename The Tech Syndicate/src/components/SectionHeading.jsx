  ...
  return (
    <div className={`mb-16 ${centered ? 'text-center flex flex-col items-center' : ''}`}>
      <motion.div
        ...
        className={`flex items-center gap-3 mb-4 ${centered ? 'justify-center' : 'justify-start'}`}
      >
      ...
      <motion.h2
        ...
        className="text-4xl md:text-5xl lg:text-6xl font-black font-heading tracking-tight text-slate-950 dark:text-white"
      >
